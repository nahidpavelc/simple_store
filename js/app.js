...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product" style="background-color:white;">
      <div>
    <img class="product-image" src=${image}></img>
      ...
      <p>
        <i class="fas fa-star" style="color:#FACA51;"></i>
        <span style="color:red;">Rating:${product.rating.rate}</span> 
        <span style="color:blue;"}>(${product.rating.count})</span>
      </p>
      ...
      <div class="d-flex justify-content-around">
        ...
        <!-- <div class="modal-dialog modal-dialog-centered">
          <button onclick="addToCart(${product.description})" id="details-btn" class="btn btn-danger">Details</button>
        </div> --!>
...
const addToCart = (id, price) => {
  ...
  updateTaxAndCharge("total-tax", price);
...
const updateTotalPrice = () => {
  ...
  // const total = price + deliveryCharge + totalTax;
  // setInnerText("total", total);

  // // PRICE 
  // let price = document.getElementById("price");
  // let priceOutput = parseFloat(price.innerText);
  // // dELIVERY 
  // let delivery = document.getElementById("delivery-charge");
  // let deliveryOutput = parseFloat(delivery.innerText);
  // // total 
  // let totalValue = document.getElementById("total");

  // let totalSum = priceOutput + deliveryOutput;
